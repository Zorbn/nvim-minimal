...
let s:diff_delete       = "#ffadad"      " #ff1414
...
call s:hi ("WarningMsg",    s:base1,            s:diff_change,  "none")
call s:hi ("Error",         s:base1,            s:diff_delete,  "none")
call s:hi ("FoldColumn",    s:base3,            s:base6,        "none")
call s:hi ("Ignore",        s:base4,            s:base7,        "none")
call s:hi ("MatchParen",    s:base1,            s:yellow_bg,    "none")
call s:hi ("ModeMsg",       s:teal_text,        s:teal_bg,      "bold")
call s:hi ("Normal",        s:base1,            s:base7,        "none")
call s:hi ("Search",        "",                 s:yellow_bg,    "none")
